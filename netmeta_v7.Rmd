---
title: "Network Meta-Analysis, Version 7"
output:
  html_notebook:
    number_sections: yes
    toc: TRUE
...
# Load data
```{r data}
dt1 <- fread("data/DAPT Excel Sheet 11242019.csv")
...
dt2 <- dt1[!(Study %in% c("SMART Choice",
                          "GLOBAL LEADERS",
                          "TWILIGHT")), ]
foo_no_p2(ep = "CV Death", dtt = dt2)
```
